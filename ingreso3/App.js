...
import Crearliga from './componentes/perfil/Crearliga';
import Crearequipo from './componentes/perfil/Crearequipo';
import Pago from './componentes/perfil/Botonpago';
import Perfil from './componentes/perfil/Perfil';
import Calendario from './componentes/calendario/calendario';
import Vaticinio from './componentes/calendario/vaticinio';
import Posicionese from './componentes/perfil/posiciones';
import Posicioness from './componentes/noticias/posiciones';
...
import {LoginScreen,LigaScreen,equipoScreen,pagoScreen,bdScreen,vaticinioScreen,perfilScreen, posicioneScreen,calendarioScreen,infoScreen,newsScreen, posicionsScreen,loginStack,miPerfilStack,calendarioStack,noticiasStack} from './Screennames';
...
const perfilStack = createStackNavigator({
  ...
  posicioneScreen: {screen:Posicionese}
}
);

const calendarStack = createStackNavigator({
  calendarioScreen: {screen:Calendario},
  vaticinioScreen: {screen:Vaticinio}
});

const newsStack = createStackNavigator({
  newsScreen: {screen:Noticias},
  posicionsScreen: {screen:Posicioness}
});

/*const cambioStack=createSwitchNavigator({
  loginStack: RootStack,
  miPerfilStack: perfilStack,
  calendarioStack: calendarStack
})*/
