  ...
  render() {
    ...
    return (
      <Container style={styles.container}>
        ...
        <Content>          
                <Text style={{color:'white'}}>{JSON.stringify(detalle)}</Text>

            <Label style={{color:'white'}}> Seleccione un equipo </Label>
          ...
          <Text style={{color:'white'}}>{JSON.stringify(seleccion1)}</Text>
          <Item floatingLabel>
            ...
            <Text style={{color:'white'}}>{JSON.stringify(seleccion2)}</Text>
          <Item floatingLabel>
                <Label>Marcador</Label>
                <Input autoCorrect={false}
                 autoCapitalize="none"
